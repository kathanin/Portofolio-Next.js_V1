...
import Link from "next/link"; // [Perubahan 2]
import SocialLinks from "./SocialLinks"; // Disesuaikan path-nya jika di folder components
import Komentar from "./Commentar"; // Disesuaikan path-nya jika di folder components
import Swal from "sweetalert2";
import AOS from "aos";
import "aos/dist/aos.css";
import axios from "axios";

// [Perubahan 3: Interface untuk State Form]
...
const ContactPage = () => {
  // [Perubahan 4: Penerapan Tipe pada useState]
  ...
  // [Perubahan 5: Tipe pada Event onChange]
  const handleChange = (
  ...
  // [Perubahan 6: Tipe pada Event onSubmit]
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // [Perubahan 7: Penanganan Error Type]
