...
import { Code2, Github, Globe, User, LucideIcon } from "lucide-react";
import AOS from "aos";
import "aos/dist/aos.css";

// [Perubahan 2: Definisi Interface TypeScript]
...
const TypewriterEffect: React.FC<TypewriterEffectProps> = ({ text }) => {
  ...
  useEffect(() => {
    let index = 0;
    // [Perubahan 3: Tipe Return untuk setInterval]
...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onLoadingComplete }) => {
  ...
  return (
    <AnimatePresence>
      {isLoading && (
        <motion.div
          className="fixed inset-0 bg-[#030014] z-50" // Ditambahkan z-50 agar selalu di depan
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit="exit"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="www.kthanin.vercel.app" />
                    </span>
                  </div>
                </a>
              </motion.div>
