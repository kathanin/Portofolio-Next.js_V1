...
// [Perubahan 2: Interfaces untuk Props]
...
// Memoized Components dengan TypeScript
...
StatusBadge.displayName = "StatusBadge"; // [Perubahan 3]
...
const TechStack = memo(
  (
    { tech }: TechStackProps, // [Perubahan 4]
  ) => (
...
const CTAButton = memo(
  (
    { href, text, icon: Icon }: CTAButtonProps, // [Perubahan 4]
  ) => (
    <a href={href}>
...
const SocialLink = memo(
  (
    { icon: Icon, link }: SocialLinkProps, // [Perubahan 4]
  ) => (
...
const WORDS: string[] = ["UI/UX Designer", "Tech Enthusiast"]; // [Perubahan 5]
const TECH_STACK: string[] = ["Next.js", "React", "Typescript", "Tailwind"]; // [Perubahan 5]
