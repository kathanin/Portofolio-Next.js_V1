        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Sebagai lulusan Teknik Informatika, saya berdedikasi menjadi UI/UX
              Programmer yang menerjemahkan ide visual menjadi pengalaman
              digital yang interaktif dan responsif. Berbekal keahlian dalam
              React.js, Next.js, dan Tailwind CSS, saya berfokus pada
              pengembangan antarmuka web yang inovatif, fungsional, dan selalu
