...
import {
  ...
  Youtube,
  ExternalLink,
  LucideIcon, // [Perubahan 2] Import tipe icon
} from "lucide-react";
import AOS from "aos";
import "aos/dist/aos.css";

// [Perubahan 3: Interface TypeScript]
interface SocialLink {
  name: string;
  displayName: string;
  subText: string;
  icon: LucideIcon | React.FC<React.SVGProps<SVGSVGElement>>; // Icon bisa berupa Lucide atau Custom SVG
  url: string;
  color: string;
  gradient: string;
  isPrimary?: boolean;
...
const socialLinks: SocialLink[] = [
  ...
  },
  {
    ...
    displayName: "Tiktok",
    subText: "@kathanin",
    // [Perubahan 4: Typing untuk Custom Icon]
...
const SocialLinks = () => {
  ...
  // [Perubahan 5: Validasi agar TypeScript tidak menganggap undefined]
  if (!linkedIn || otherLinks.length < 4) return null;
