...
import { LucideIcon } from "lucide-react"; // [Perubahan 2: Import Tipe Ikon]
...
interface InputFieldProps {
  ...
  formData: Record<string, any>; // Record untuk menerima object state apapun
  handleChange: (
...
const InputField: React.FC<InputFieldProps> = ({
  ...
  const getInputClasses = (isTextArea: boolean = false) => {
    const baseClasses = `
